...
export class WildcardCommandSystem {
   ...
   */
  register(name: string, template: CommandTemplate) {
   ...
   */
  listCommands(): Array<{ pattern: string; description: string; riskLevel: string }> {
   ...
   */
  getHistory(limit: number = 10): typeof this.executionHistory {
   ...
   */
  learnFromSuccess(problem: string, commands: string[]) {
