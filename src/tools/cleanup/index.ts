...
export class CleanupAnalyzeWasteTool {
  async execute(args: CleanupAnalyzeWasteArgs): Promise<CleanupAnalysisResult> {
...
export class CleanupExecuteSmartTool {
  async execute(args: CleanupExecuteSmartArgs): Promise<ToolResult> {
...
export class CleanupDuplicateResolverTool {
  ...
  private async sortByStrategy(files: string[], strategy: string): Promise<string[]> {
