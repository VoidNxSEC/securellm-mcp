...
import type {
  ...
  EnrichedContext,
  ProjectState,
} from "../../types/context-inference.js";
...
export class ContextEnricher {
   ...
   */
  async enrich(initialContext: EnrichedContext, projectRoot: string): Promise<EnrichedContext> {
  ...
  private needsFileScan(analysis: InputAnalysis): boolean {
    return (
      ...
      analysis.topics.some((t) => t.name === "code" || t.name === "file")
    );
  }
