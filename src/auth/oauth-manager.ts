...
export abstract class OAuthManager {
   ...
   */
  public buildAuthorizationUrl(usePKCE: boolean = true): string {
   ...
   */
  public async exchangeToken(request: OAuthTokenRequest): Promise<OAuthToken> {
   ...
   */
  public abstract getUserInfo(token: OAuthToken): Promise<any>;
}
