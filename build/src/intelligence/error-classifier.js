export class ErrorClassifier {
    ...
    generateProblemDescription(errorName, extracted) {
        switch (errorName) {
            case "hash_mismatch":
    ...
    generateCauseDescription(errorName, extracted) {
        switch (errorName) {
            case "hash_mismatch":
    ...
    generateSolution(errorName, extracted) {
        switch (errorName) {
            case "hash_mismatch":
    ...
    generateFixCommand(fixType, extracted) {
        switch (fixType) {
            case "UPDATE_HASH":
